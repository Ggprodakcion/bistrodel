...
interface SupportTicket {
  ...
  date: string
  isUnread: boolean // Добавляем флаг непрочитанного сообщения
...
export default function AdminSupportChatPage() {
  ...
  useEffect(() => {
    ...
    if (foundTicket) {
      ...
      // Redirect if ticket not found (e.g., if URL was manually typed for non-existent ticket)
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (newMessage.trim() && ticket) {
      const newMsg: Message = {
        ...
        sender: "manager", // Admin is sending the message
